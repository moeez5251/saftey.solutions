    ...
    <>
      <nav className="sticky top-0 z-50 bg-white shadow-md border-b border-gray-200">
        ...
        <div className="fixed bottom-6 right-6 z-[1000] md:bottom-8 md:right-8">
          <a
            href="https://wa.me/+923001234567" // ← CHANGE TO YOUR REAL NUMBER
            target="_blank"
          ...
          >
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.198-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.297-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.29.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.515-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.648 11.648 0 0012.004 2C6.486 2 2 6.484 2 12c0 2.176.605 4.267 1.755 6.105L2 22l3.948-1.036A11.646 11.646 0 0012 20c6.52 0 11.999-5.48 11.999-12.002 0-3.21-1.28-6.23-3.586-8.498z" fill="currentColors"/>
            </svg>
