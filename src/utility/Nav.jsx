...
function Nav() {
  ...
  const { cartItems, totalItems, totalAmount, removeFromCart } = useCart();
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white shadow-md border-b border-gray-200">
        ...
        {/* Cart Popup - Now shows real items */}
        {showCart && (
      ...
      <div className="flex flex-col h-full">
        {cartItems.length === 0 ? (
          ...
          <>
                ...
                <div key={item.id} className="flex gap-4 py-5 border-b border-gray-100 last:border-0">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-orange-600 font-semibold mt-1">
                      Rs. {item.price?.toLocaleString("en-IN") || "Contact"}
                    </p>
            ...
            <div className="border-t border-gray-200 bg-gray-50 px-6 py-6 mt-auto space-y-4">
              {/* Total */}
              ...
              {/* Checkout Button - Right after total */}
              <Link
                to="/checkout"
                onClick={() => setShowCart(false)}
              ...
              {/* Optional: Continue Shopping button at the very end */}
              <button
                onClick={() => setShowCart(false)}
                className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold text-lg py-4 rounded-xl transition"
              >
                Continue Shopping
              </button>
            </div>
